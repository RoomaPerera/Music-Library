                    ...
                    <div class="card-body">
                        <form action="{{route('songs.update', $song->id)}}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Title" name="title" id="title" value="{{old('title', $song->title)}}"/>
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('artist') is-invalid @enderror" placeholder="Artist"  name="artist" id="artist" value="{{old('artist', $song->artist)}}"/>
                                @error('artist')
                                    <p class="invalid-feedback">{{$message}}</p>
                                @enderror
                            </div>
